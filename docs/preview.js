...
$m['src/graphicsDefs'].exports = {
  ...
  '02d': srcgraphicsDefs__masked(srcgraphicsDefs__BASE.sun2, srcgraphicsDefs__BASE.cloud1, 4),
  '03d': srcgraphicsDefs__masked(srcgraphicsDefs__BASE.sun3, srcgraphicsDefs__BASE.cloud2, 5),
  '40d': srcgraphicsDefs__masked(srcgraphicsDefs__BASE.sun3, srcgraphicsDefs__BASE.cloud3, 5).concat(srcgraphicsDefs__BASE.rain1)
...
function srcgraphicsDefs__masked(back, front, offset) {
  return [Object.assign({ mask: Object.assign({ offset: offset }, front) }, back), front];
}
/*≠≠ src/graphicsDefs.js ≠≠*/
...
var srcpreviewpreview__symbolComponent = $m['src/index'].exports;
