...
require.register('primitives/LightningPrimitive', function(module, exports, require) {
  var svg = require('svg@0.1.1')  
  	...
  	, FILL_COLOUR = require('yr-colours@0.2.0').LIGHTNING  
...
require.register('animated/animator', function(module, exports, require) {
...
require.register('../js-preview/symbolGroup', function(module, exports, require) {
  var nunjucks = require('nunjucks');
  var template = (function() {(window.nunjucksPrecompiled = window.nunjucksPrecompiled || {})["../js-preview/symbolGroup"] = (function() {function root(env, context, frame, runtime, cb) {
  var lineno = null;
  var colno = null;
  var output = "";
  try {
  ...
  module.exports.render = function (data, fn) {
    nunjucks.render('../js-preview/symbolGroup', data, fn);
  };
});
...
require.register('../js-preview/index', function(module, exports, require) {
  ...
  var svg = require('svg@0.1.1')
  	...
  	, template = require('../js-preview/symbolGroup')
